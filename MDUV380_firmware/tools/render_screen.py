...
# Від розташування САМОГО скрипта, а не абсолютним шляхом теки розробки: цей файл
# імпортує check_smeter_align.py, який ходить у CI, де такої теки немає взагалі.
# (2026-09-04: тут уже виправляли шлях ЗБЕРЕЖЕННЯ прев'ю, а цей -- ЧИТАННЯ -- проґавили,
# і CI впав саме на ньому.)
